...
public class Triangle extends PlaneShape {
	...
	public double getPerimeter() {
		double perimeter = this.getDistanceAB() + this.getDistanceBC()
				+ this.getDistanceAC();
		return perimeter;
	}
	...
	public String toString() {
		return super.toString() + this.vertices[1].toString() + this.vertices[2].toString();
	}
	...
	private void isValidTriangle() {
		...
		if (!isTriangle) {
			throw new IllegalArgumentException(
					"Cannot create a valid triangle with this data");
		}
	}
